...
class DutyReminderApp:
    ...
    def load_data(self):
        ...
        # 单个任务的默认字段模板（新增 duty_label_color 控制浮窗颜色）
        default_task = {
            'name': '',
            'duty_list': [],
    ...
    def open_custom_voice_window(self, window):
        ...
        window_x = window.winfo_rootx() + (window.winfo_width() // 2) - 300
        window_y = window.winfo_rooty() + (window.winfo_height() // 2) - 200
        custom_window.geometry(f"600x400+{window_x}+{window_y}")
    ...
    def add_new_task(self, window):
        ...
        def add_task():
            ...
            new_task_data = {
                ...
                'override_until': None,
                'duty_label_color': 'blue'          # 新任务默认字体颜色
            }
